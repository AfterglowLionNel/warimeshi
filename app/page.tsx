...
const HOME_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "グループモードでは、お会計をちょっと盛り上げる「お楽しみ調整」を任意で使えます。" +
      "(1) 端数だけルーレット: 100円未満の端数をランダムで誰か1人に押し付ける、" +
      "(2) 1人だけ500円引き: ランダムにラッキー割対象を抽選、" +
      "(3) 全額負担ルーレット: 止まった人が全額をおごる罰ゲーム風モード、" +
      "(4) 幹事ボーナス: 払い出し担当 (幹事) を500円割引、" +
      "の4種類。スピン演出と紙吹雪エフェクト付きで、飲み会の罰ゲームや締めの一発勝負としても楽しめます。もちろん使わずに通常の均等割り精算も可能です。",
  },
] as const
