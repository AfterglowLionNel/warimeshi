...
const features = [
  ...
  },
  {
    icon: Users,
    title: "グループモード",
    desc: "招待リンクで全員の注文をリアルタイム同期。お楽しみルーレット付き。",
    href: "/group",
    accent: true,
  },
  {
      ...
      <div className="container mx-auto px-5">
        ...
        <div className="max-w-2xl mx-auto mt-12 text-[var(--wm-ink-2)]">
          ...
          <div className="space-y-3 text-sm leading-relaxed">
            ...
            <p>
              さらに <strong>お楽しみ調整 (ルーレット機能)</strong> も搭載。
              端数だけルーレット・1人だけ500円引き・全額負担ルーレット・幹事ボーナスの4種類を、
              スピン演出と紙吹雪エフェクトつきで楽しめます。飲み会の罰ゲームや締めの一発勝負としても活躍します。
            </p>
          </div>
        </div>
      </div>
